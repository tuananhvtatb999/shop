                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="${pageContext.request.contextPath}/shop/listProduct"
                                       class="nav__dropdown-item">Tất cả sản phẩm</a>
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="${pageContext.request.contextPath}/shop/listOrder"
                                       class="nav__dropdown-item">Tất cả đơn hàng</a>
                                    <a href="#"
                                        ...
                                        <span id="status">
                                            <c:choose>
                                                <c:when test="${orders.status == 1}">
                                                    <lable class="badge bg-label-secondary">Chờ xác nhận</lable>
                                                </c:when>

                                                <c:when test="${orders.status == 2}">
                                                    <lable class="badge bg-label-warning" >Chờ lấy hàng</lable>
                                                </c:when>
                        ...
                        <i class="h5" href="">${orders.orderEntity.id}</i>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <div class="avatar avatar-xl mr-3">
                                                <img class="img-fluid" src="${orders.productEntity.pathImage}"
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="btn btnArond">
                                    <a onclick="">
                                        <button type="button" class="btn btn-warning" onclick="Product.updateStatusOrder(${orders.id}, 3)">Đã Giao</button>
                                    </a>
                                    <a onclick="">

...
<body>
  ...
  <!-- ------------------------ Begin BANNER ------------------------------- -->
  <section class="banner--brand page-section" style="background-image: url('${pageContext.request.contextPath}/imgs/shop/shop-banner.webp')">
    <div class="brand__wrapper">
        ...
        <div class="brand-item__info">
          <div class="brand-item__detail-wrapper">
            ...
            <div class="brand-item__detail">
              ...
              <p class="brand-item__name-description">
                <strong>0</strong><span>người theo dõi</span>
              </p>
              <ul class="brand-item__social-list">
                ...
                <li>
                  <a href="" title="Thời gian tham gia">
                    <article class="brand-item__social-item">
                      <h6>5 tháng</h6>
                      <p>
          ...
          <div class="brand-item__description">
            <p>Nghe tớ kể về GORI SHOP: GORI SHOP ra đời với mong muốn mang đến cho các bạn trẻ những bộ quần áo đơn
              giản nhưng vẫn thể hiện được cá tính riêng. Là những con người tự do và năng động, những cái tôi đầy trẻ
              trung và phóng khoáng. Gori sẽ mang đến những sản phẩm không chỉ đẹp về mẫu mới Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Odio, nam reprehenderit? Explicabo aliquid, porro dolorem, ratione modi nisi
              qui molestiae unde id eligendi totam recusandae, aut tempora. Harum, quibusdam alias?</p>
      ...
      <div class="brand__right">
        <div class="brand-item__banner-image__wrapper">
          <img class="brand-item__banner-image" src="${pageContext.request.contextPath}/imgs/shop/shop-banner-background.webp"
      ...
      <ul class="product-slider category-about row">
        ...
        <li class="col c-6 m-4 l-2-4 py-1">
          <a href="#">
            <div class="card">
              <div class="card-img">
                <img src="${pageContext.request.contextPath}/card1.webp" alt="" />
              </div>
              <div class="card-text">
                <h3 class="card-title text-hover">TEELAB</h3>
                <p class="card-des truncate">Áo Thun Teelab Grey Trame TS049</p>
      ...
      <div class="tittle-product">
        ...
        <ul class="top-category row">
          <li class="col c-4 m-3 l-2-4">
            <a href="#">
              <div class="top-item">
                <span><img src="${pageContext.request.contextPath}/imgs/shop/shop-banner.webp" alt="Áo thun" /></span>
                <div class="top-text">
              ...
              <ul class="aside-bar__list">
                  ...
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="0" type="radio" value="0" /><label class="text-hover" for="0">Quần
                          Denim /
                          Jean</label>
                      </div>
                    </a>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="1" type="radio" value="1" /><label class="text-hover" for="1">Áo
                          Sweater</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="2" type="radio" value="2" /><label class="text-hover" for="2">Quần
                          Ngắn</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="3" type="radio" value="3" /><label class="text-hover" for="3">Áo Thun
                          Tay
                          Ngắn</label>
                      </div>
                    </a>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="4" type="radio" value="4" /><label class="text-hover" for="4">Quần
                          Dài</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="5" type="radio" value="5" /><label class="text-hover" for="5">Áo Cổ
                          Trụ</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="6" type="radio" value="6" /><label class="text-hover" for="6">Áo
                          Denim / Jean</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="7" type="radio" value="7" /><label class="text-hover" for="7">Sơ Mi
                          Tay Dài</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="8" type="radio" value="8" /><label class="text-hover" for="8">Sơ Mi
                          Tay Ngắn</label>
                      </div>
                    </a>
                  </div>
                ...
                <li class="aside-bar__item">
                  <div class="aside-bar__item-box">
                    <a class="aside-bar__item-link">
                      <div class="input--radio__wrapper">
                        <input name="category" id="9" type="radio" value="9" /><label class="text-hover" for="9">Áo Len
                          /
                          Cardigan</label>
                      </div>
                    </a>
        ...
        <div class="brand-store__right">
              ...
              <div class="tab-bar__filter-list">
                ...
                <div class="tab-bar__filter-item">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown__select-list">
                      <input class="dropdown__select-item" id="type_all" name="type_category" type="radio" value="">
                      <label class="btn" for="type_all"><span>Toàn
                          bộ</span></label>
                      <input class="dropdown__select-item" id="type_male" name="type_category" type="radio"
                        value="male"><label class="btn" for="type_male"><span>Nam</span></label><input
                        class="dropdown__select-item" id="type_female" name="type_category" type="radio"
                        value="female"><label class="btn" for="type_female"><span>Nữ</span></label><input
                        class="dropdown__select-item" id="type_accessory" name="type_category" type="radio"
                ...
                <div class="tab-bar__filter-item">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="divider"></div>
                    <div class="dropdown__select-list">
                      <input class="dropdown__select-item" id="sort_all" name="type_sort" type="radio" value="">
                      <label class="btn" for="sort_all"><span>Toàn
                          bộ</span></label>
                      <input class="dropdown__select-item" id="sort_trending" name="type_sort" type="radio"><label
                        class="btn" for="sort_trending"><span>Nổi bật</span></label><input class="dropdown__select-item"
                        id="sort_new" name="type_sort" type="radio"><label class="btn" for="sort_new"><span>Mới
                          về</span>
                ...
                <div class="tab-bar__filter-item">
                  <button class="btn filter-item__button" onclick="showDropdown(2)">
                    <span class="filter-item__text">Giá cả</span><i class="fas fa-caret-down filter-icon"></i></button>
                  <div class="dropdown">
                    <div class="dropdown__type">
                      <span class="dropdown__text">
                        <h5>Giá cả</h5>
          ...
          <div>
            ...
            <div>
              ...
              <button class="button primary-button" style="width: 150px; margin: auto; display: none" disabled="">
          ...
          <div class="tab-bar__filter-list review-filter">
            ...
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterTime(1)">
                <span class="filter-item__text">Thời gian</span><i class="fas fa-caret-down filter-icon"></i></button>
            </div>
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterReview(2)">
                <span class="filter-item__text">5</span><i class="fas fa-star star-icon active"></i></button>
            </div>
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterReview(3)">
                <span class="filter-item__text">4</span><i class="fas fa-star star-icon active"></i></button>
            </div>
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterReview(4)">
                <span class="filter-item__text">3</span><i class="fas fa-star star-icon active"></i></button>
            </div>
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterReview(5)">
                <span class="filter-item__text">2</span><i class="fas fa-star star-icon active"></i></button>
            </div>
            <div class="tab-bar__filter-item">
              <button class="btn filter-item__button" onclick="filterReview(6)">
                <span class="filter-item__text">1</span><i class="fas fa-star star-icon active"></i></button>
            </div>
          </div>
        </div>
        <!-- ------------------------ IF HAS REVIEWS ------------------------------- -->
        ...
        <div class="feedback">
          <div class="box">
            <div class="review-item__info">
              <a href="#">
                <img width="40" height="40" class="user__avatar" src="/assets/img/shop/shop-banner.webp"></a>
              <div class="user__rating-wrapper">
                ...
                <div class="review-item__preview">
                  <div class="review-preview__left">
                    <div class="review-preview__product"><a href=""><img class="review-preview__product-img"
                          alt="Áo Thun Tay Lỡ Nữ Nam Form Rộng URBAN OUTFITS In To The Future ATO29 Cotton"
                          title="Áo Thun Tay Lỡ Nữ Nam Form Rộng URBAN OUTFITS In To The Future ATO29 Cotton" width="76"
              ...
              <div class="card-item_list">
                <a class="block_link" href="/" title="COD Tiền mặt">
                  <div class="card-item_box">
                    <div class="card-item_icon"><img src="/assets/img/social/cod.webp" alt="Tiền mặt" title="Tiền mặt">
                    </div>

                  ...
                  <div data-i18n="AddSubCategory">Add Sub Category</div>
					...
					<li class="menu-item"><a href="javascript:void(0);"
						class="menu-link menu-toggle"> <i
							...
							<div data-i18n="Misc">Request</div>
					</a>
						<ul class="menu-sub">
							<li class="menu-item"><a href="../html/RequestShop.html"
								class="menu-link">
									<div data-i18n="Error">Request Shop</div>
							</a></li>
							<li class="menu-item"><a href="../html/RequestProduct.html"
								class="menu-link">
									<div data-i18n="Under Maintenance">Request Product</div>
							</a></li>
						</ul></li>
					<!-- Components -->
					<li class="menu-header small text-uppercase"><span
				...
				<div class="content-wrapper">
					...
					<div class="col-sm-12 center-block">
						<div class="card-body">
							<div class="card mb-4 ">
								<form:form
									action="${pageContext.request.contextPath}/admin/approveRequestShop"
									method="post" modelAttribute="shopEntity">
									<form:hidden path="id" readonly="true" />
									<form:hidden path="linkImage" readonly="true" />
									<form:hidden path="userEntity.id" readonly="true" />
									<form:hidden path="userEntity.username" readonly="true" />
									<form:hidden path="userEntity.password" readonly="true" />
									<form:hidden path="userEntity.phoneNumber" readonly="true" />
									<form:hidden path="userEntity.createTime" readonly="true" />
									<form:hidden path="userEntity.birthDay" readonly="true" />

									<form:hidden path="userEntity.address" readonly="true" />
									...
									<div class="card-body ">
										<div class="add-Name-Code">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label for="productMaterial" class="input-label">Gmail</label>
														<form:input path="userEntity.email" type="text"
	...
	function showNotification(from, align, message) {
	    ...
	    $.notify({
		 ...
		 function showMessApprove(id) {
			var option = confirm('Are you sure to Approve ' + id);
			if (option === true) {
				var data = {};
				data["id"] = id;
				data["status"] = 1;
				$.ajax({
					url: "/admin/doUpdateShopStatus",
					type: "post",
					...
					success: function(result){
						if(result === 200){
							window.location.href = '/admin/requestShop';
		...
		function showMessReject(id) {
			var option = confirm('Are you sure to Reject ' + id);
			if (option === true) {
				var data = {};
				data["id"] = id;
				data["status"] = 2;

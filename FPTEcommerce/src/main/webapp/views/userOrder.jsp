            ...
            <div class="order-box box">
              <div class="order-box__top">
                <div class="order__user-info">
                  <span class="order__user-info__brand">Nguyen Tran Shop</span>
                 
                  <a class="btn btn-badge-border" href="./shop.html">
                    <div class="btn-inner">
                ...
                <div class="order__state-display">
                  <div class="order__product-state">
                    ...
                    <div class="order__product-state__text">Đang trong quá trình giao hàng</div>
                  </div>
              ...
              <div class="order-box__mid">
                <div class="order-box__mid-left">
                  <div class="order-box__product">
                    <div class="order-product__img"><img src="../assets/img/product/card2.webp" width="85px" height="85px" />
                    </div>
                    <div class="order-product__detail">
                      <div class="order-product__name">Name Of Product Here</div>
                      <div class="order-product__description">Size: <span>S</span></div>
                      <div class="order-product__description">Color <span>Red</span></div>
                ...
                <div class="order-box__mid-right">
                  <div class="order-product__price--old">53.313đ</div>
                  <div class="discountPercent"><i>-</i>10<i>%</i></div>
                  <div class="order-product__price--new text-highlight price">51.313đ</div>
                </div>
              </div>
              <div class="order-box__bot">
                <div class="order-box__total">
                  ...
                  <span class="order-box__total-price text-highlight">51.313đ</span>
                </div>

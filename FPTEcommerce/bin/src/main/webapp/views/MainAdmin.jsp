...
<!-- Helpers -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/vendor/js/helpers.js">

<!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
<!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/js/config.js">
	<div class="preloader">
					...
					<li class="menu-item"><a href="javascript:void(0);"
						...
						<ul class="menu-sub">
							<li class="menu-item"><a href="layouts-without-menu.html"
								class="menu-link">
									<div data-i18n="Without menu">Without hahaaa</div>
							</a></li>
